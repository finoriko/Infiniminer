...
namespace Infiniminer
{
    ...
    public class ParticleEngine
    {
        ...
        public ParticleEngine(InfiniminerGame gameInstance)
        {
            ...
            vertexBuffer = new VertexBuffer(gameInstance.GraphicsDevice, vertexDeclaration,vertices.Length * VertexPositionTextureShade.SizeInBytes, BufferUsage.WriteOnly);
