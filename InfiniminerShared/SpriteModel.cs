...
namespace Infiniminer
{
    ...
    public class SpriteModel
    {
        ...
        public void Draw(Matrix viewMatrix, Matrix projectionMatrix, Vector3 cameraPosition, Vector3 cameraForward, Vector3 drawPosition, Vector3 drawHeading, float drawScale)
        {
            ...
            //graphicsDevice.BlendState.AlphaTestEnable = true;
            //graphicsDevice.BlendState.AlphaFunction = CompareFunction.Greater;
            //graphicsDevice.BlendState.ReferenceAlpha = 128;
            graphicsDevice.DepthStencilState = DepthStencilState.DepthRead;
            graphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleList, vertices, 0, vertices.Length / 3);

            //graphicsDevice.BlendState.AlphaTestEnable = false;
